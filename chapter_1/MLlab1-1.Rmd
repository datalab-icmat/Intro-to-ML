...
En estos labs 1.* hacemos una intro a ML.  Recordamos regresión lineal y el problema de sobreajuste. Después se discute el problema de selección de modelos en knns y concluimos con una breve ilustración de regresión logística.  Revisamos como ejemplo de aprendizaje no supervisado algunas cuestiones sobre ACPs, primero una ilustración básica y luego dos ilustraciones a proyección y compresión. Finalmente, se recuerdan conceptos de optimización en R y validación. Esta primera parte 1.1 se refiere a regresión lineal.
...
head(Carseats)
```
Ajustamos un modelo lineal para las ventas. Algunas variables son cualitativas y R crea automáticamente variables dummy. Ajustamos un modelo lineal con interacciones. Price:Age
...
summary(fit3)
```
Ahora hacemos las predicciones con los dos primeros modelos
```{r ,eval=FALSE}
